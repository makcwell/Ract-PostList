        ...
        >
            ...
            <CardContent className={s.pointer}
                ...
                <Stack mt={2} direction="row" spacing={1}>
                    {card.tags.map((item) =>
                        <Chip label={item} key={item} size="small"  color="success"/>
                    )}
                </Stack>
            </CardContent>
                        ...
                        <div className={s.boxSvg}>
                            <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path clipRule="evenodd"
                                      d="M12 19.343c-.04 0-.11-.049-.201-.117C7.579 16.5 3.62 12.569 3.62 8.921c0-2.608 1.732-4.344 4.069-4.344 1.893 0 2.98 1.148 3.625 2.128.272.392.443.5.685.5.242 0 .393-.118.685-.5.695-.96 1.742-2.128 3.625-2.128 2.337 0 4.069 1.736 4.069 4.344 0 3.647-3.958 7.578-8.168 10.303-.1.07-.17.118-.211.118Z"></path>
                            </svg>
                            {card.likes.length}
                        </div>
                        <div className={s.boxComm}>
                            <svg viewBox="64 64 896 896" focusable="false" data-icon="comment" width="1em" height="1em"
                                ...
                                <path
                                    d="M433 421c-23.1 0-41 17.9-41 40s17.9 40 41 40c21.1 0 39-17.9 39-40s-17.9-40-39-40z"></path>
                            </svg>
                            {card.comments.length}
                        </div>
                    </div>
                    <div className={s.cardFooter__date}>{new Date(card.created_at).toLocaleString('ru-RU', {
